...
<body>
    ...
    <main class="container-fluid" style="">
        <div id="content" class="d-grid text-center text-dark bg-secondary-subtle mt-6 w-75 mx-auto mb-4 p-4 
                                rounded border border-maincolor border-2 row-gap-3 fs-5 pt-3">
            ...
            <div id="event-list-header" class="event-li row border-bottom border-dark border-2 mb-2">
            ...
            <div class="event-li row border border-dark border-2 rounded py-2 align-items-center">
