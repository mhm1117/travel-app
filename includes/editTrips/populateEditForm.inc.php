...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    try {
        ...
        // include "includes/editTrips/populateEditForm.inc.php";
        echo '<div class="modal fade editTripModal" id="editTripModal" tabindex="-1" data-bs-backdrop="static">
                        ...
                        <form action="includes/editTrips/tripFormHandling.inc.php" method="POST">
                            <div class="modal-body">
                                ...
                                <div class="input-group mb-2">
                                    ...
                                    <input type="text" name="tripName" class="form-control" placeholder="Trip Name" value="' . $trip["name"] . '"> 
                                </div>
                                <div class="input-group mb-2">
                                    <span class="input-group-text">Who Is Going:</span>
                                    <input type="text" id="tripPpl" name="tripPpl" class="form-control" placeholder="Mattie, Angie, etc." value="' . $trip["people"] . '"> 
                                </div>
                                <div class="input-group mb-2">
        ...
        echo 'let myModal = new bootstrap.Modal(document.getElementById("editTripModal"));
              myModal.show();';
