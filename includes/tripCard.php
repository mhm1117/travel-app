<?php 
    ...
    foreach ($results as $trip) {
        echo '<div class="card mb-4 tripCard" style="width: 250px; height: fit-content;" id="tripCard-' . $trip["id"] . '">
                <img src="' . $trip["img"] . '" class="d-none d-sm-block card-img-top" alt="trip-image" style="max-height: 6.2em;">
                <div class="card-body">
                ...
                <div class="d-flex flex-nowrap align-items-center justify-content-between">
                    ...
                    <span>
                    <a type="button" id="" class="text-maincolor editTripBtn" data-bs-toggle="modal" data-bs-target="#editTripModal">
